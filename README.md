...
| Сервис | URL | Описание |
|--------|-----|----------|
| **Frontend** | http://localhost:8302 | Веб-интерфейс платформы |
| **Backend API** | http://localhost:8301 | REST API |
| **API Docs** | http://localhost:8301/docs | Swagger документация |
| **Airflow** | http://localhost:8308 | Управление ETL процессами |
| **Elasticsearch** | http://localhost:8307 | Поисковый движок |
...
Airflow автоматически синхронизирует данные с Elasticsearch каждые 15 минут.

Доступные DAG'и:
- `sync_courses_to_elasticsearch` - синхронизация курсов
- Управление через http://localhost:8380
